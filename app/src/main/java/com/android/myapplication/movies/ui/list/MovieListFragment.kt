...
import com.android.myapplication.movies.ui.genre.GenreDialogFragment
...
class MovieListFragment : Fragment() {
    ...
    private val genreDialog by lazy { GenreDialogFragment() }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.imageFilter.setOnClickListener {
            genreDialog.apply {
                onApplyListener = {
                    movieListViewModel.genreIds = ""
                    movieListViewModel.genreIds = it.joinToString(",")
                    getMovieList()
                }
            }.showNow(childFragmentManager, GenreDialogFragment.TAG)
        }
    }
